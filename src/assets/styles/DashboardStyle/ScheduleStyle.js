...
const ScheduleStyle = StyleSheet.create({
    ...
    firstButton: {backgroundColor: backColor, width: wp(27.5), marginLeft: wp(8), borderRadius: 20, justifyContent: 'center',},
    ...
    buttonsTextRow2: {color: 'black', fontFamily: 'Poppins-Regular',fontSize: 12,textAlign: 'center',},
