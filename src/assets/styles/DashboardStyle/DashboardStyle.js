...
const DashboardStyle = StyleSheet.create({
    ...
    leftContFirstHeading: {width: wp('50'), marginTop: wp('-15')},
    leftContFirstHeadingText: {fontFamily: 'Poppins-Bold', color: 'white', fontSize: wp('4.1')},
    leftContSecondHeading: {width: wp('40'), marginBottom: wp('0')},
    ...
    neoDiscoverButton: {marginBottom: wp('-10'), width: wp('22'), height: wp('8'), borderRadius: wp('5'), shadowRadius: 4, backgroundColor: 'rgba(195, 140, 222, 0.8)', justifyContent: 'center', alignItems: 'center'},
