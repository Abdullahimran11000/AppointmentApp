...
const ChatStyle = StyleSheet.create({
    ...
    headerInnerViewIcons: {flexDirection:"row",position:"absolute",right:wp(14),top:hp(2)},
    ...
    messageImage1:{width:wp (10) , height: hp(5),borderRadius:30,left: wp(77),bottom:hp(4.5)},
    textRight: {textAlign:"center",color:AppColor.white,fontFamily:'Poppins-Regular',fontSize:12},
    subHeadingTextOne: {left:wp(55),top:hp(5),fontFamily:'Poppins-Regular',fontSize:10},
    ...
    subHeadingTextTwo: {top:hp(5),fontFamily:'Poppins-Regular',fontSize:10},
    ...
    subHeadingTextThree: {left:wp(55),top:hp(5),fontFamily:'Poppins-Regular',fontSize:10},
    ...
    messageImage3:{width:wp (10) , height: hp(5),borderRadius:30,left: wp(77),bottom:hp(16.5)},
