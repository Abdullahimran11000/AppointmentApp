...
const VerificationStyle = StyleSheet.create({
  mainView: {backgroundColor: AppColor.whiteShade, display: 'flex', flex: 10},
  ...
  viewOne:{width: wp('100'), alignItems: 'center',justifyContent: 'center',},
  textOne: {fontFamily: 'Poppins-Light',fontSize: wp('3'),color: AppColor.red,},
});
