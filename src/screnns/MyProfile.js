...
import Header from '../components/ScrennHeader/BackButton'
    ...
    <SafeAreaView style={MyProfileStyle.mainView}>
      ...
      <View style={{flex: 9}}>
        <ScrollView
          ...
          <Text style={MyProfileStyle.TextStyle}>Full Name {ast.asterik}</Text>
          ...
          <Text style={MyProfileStyle.TextStyle}>Date of Birth {ast.asterik}</Text>
          ...
          <Text style={MyProfileStyle.TextStyle}>Gender {ast.asterik}</Text>
          ...
          <Text style={MyProfileStyle.TextStyle}>Email {ast.asterik}</Text>
          <NeoTextInput
            value={emailText}
            reference={emailRef}
          ...
          <Text style={MyProfileStyle.TextStyle}>Mobile Number {ast.asterik}</Text>
          <NeoTextInput
            value={mobileNoText}
            reference={mobileRef}
