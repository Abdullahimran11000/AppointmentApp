...
const LeftChatCard = ({item}) => {
  return (
    <View style={{height:hp(14)}}>
      <Neomorph style={{left:wp(13),top:hp(4.5),width: wp(55) ,height: hp(5), backgroundColor: AppColor.whiteShade, justifyContent:'center', alignItems:'center',borderRadius:wp(10), shadowRadius:4}}>
      <View>
      ...
      <Image style={ChatStyle.messageImage2}
